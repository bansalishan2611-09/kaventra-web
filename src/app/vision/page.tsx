    ...
    <div className="bg-black text-white min-h-screen pt-40 pb-20">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <p className="text-xl text-white/60 font-light leading-relaxed mb-16">
          A unified ecosystem for the people building tomorrow. A future where developers, creators, students, builders and thinkers can access seamless technology designed to help them create, learn and move forward.
        </p>
